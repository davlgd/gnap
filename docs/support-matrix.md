...
| Active AS/RS probes | Project tooling; endpoint-owner authorization required | Required tool, initially operator-approved targets only | **Partial**: bounded rejection probes and AS OPTIONS discovery, with [probe tests](../apps/conformance-web/src/probe.rs), [earlier live observations](validation-2026-09-05.md) the [6 September hosted probe](validation-2026-09-06.md), and a [real discovery network smoke](../apps/conformance-web/LIVE_SMOKE.md). Neither rejection nor discovery probes exercise a full authenticated flow or prove that announced capabilities work. |
